...
<div class="right">
    ...
    <div class="search">
        <fm:form modelAttribute="Showprovider" method="post" action="${pageContext.request.contextPath }/FindProviderPaging.action">
            ...
            <a href="${pageContext.request.contextPath }/addProviderWindow.action">添加供应商</a>
        </fm:form>
    </div>
    <!--供应商操作表格-->
    ...
    <input type="hidden" id="userAction" value="${pageContext.request.contextPath }/FindProviderPaging.action"/>
